...
const PAYMENT_METHODS = [
  ...
  },
  {
    ...
    warning: "\u26a0\ufe0f Transfer $20 / 5500 PKR to the wallet and enter the unique ID generated by EasyPaisa in the transaction field.",
  },
  {
    id: "paypal",
    name: "PayPal",
    ...
    warning: "\u26a0\ufe0f International registration fee is $20 USD. Provide the generated PayPal receipt ID as your Transaction ID.",
  },
];
        ...
        <div className="rounded-2xl border border-slate-200 bg-white p-6 shadow-lg">
          ...
          <form onSubmit={handleSubmit} className="space-y-4">
            ...
            <div className="rounded-lg bg-amber-50 p-3 text-xs text-amber-700">
              <p className="font-medium">Note: $20 provides access to whole RCM</p>
            </div>
